        ...
        <header className="mb-8 flex flex-wrap items-start justify-between gap-4">
          <div>
            ...
            <div className="mt-3 flex flex-wrap items-center gap-2">
              <span className="rounded-full bg-[var(--ch-page-bg)] px-2.5 py-1 text-xs font-semibold uppercase tracking-widest text-[var(--ch-text-secondary)]">
                {budget.status}
              </span>
              <span className="rounded-full border border-[var(--ch-accent)]/30 bg-[var(--ch-accent)]/10 px-2.5 py-1 text-xs font-semibold uppercase tracking-widest text-[var(--ch-accent)]">
                Draft budget
              </span>
            </div>
          </div>
          ...
          <tr key={line.id} className="border-t border-[var(--ch-border)] hover:bg-[var(--ch-surface)]">
              ...
              <td key={field} className="px-4 py-2.5 text-right">
                {editingCell?.lineId === line.id && editingCell.field === field ? (
                  <input
                    ...
                    className="w-full rounded border border-[var(--ch-accent)]/50 bg-[var(--ch-page-bg)] px-2 py-1 text-right text-[var(--ch-text-primary)] outline-none"
                  />
                ) : (
                  <button
                    type="button"
            ...
            <td className="px-4 py-2.5 text-center">
              <button
                ...
                className="rounded border border-[var(--ch-accent)]/30 px-2 py-1 text-xs font-semibold text-[var(--ch-accent)] opacity-70 transition hover:bg-[var(--ch-accent)]/10 hover:opacity-100"
              >
                PO+
              </button>
            </td>
...
function IssuePODrawer({
  ...
  return (
    <div className="fixed inset-0 z-50 flex justify-end">
      ...
      <div className="relative flex h-full w-full max-w-md flex-col gap-5 overflow-y-auto border-l border-[var(--ch-border)] bg-[var(--ch-surface)] p-6">
        ...
        <div className="space-y-4">
          <div>
            ...
            <select
              ...
              className="mb-2 w-full rounded-lg border border-[var(--ch-border)] bg-[var(--ch-surface)] px-3 py-2 text-sm text-[var(--ch-text-primary)] focus:border-[var(--ch-accent)]/50 focus:outline-none"
            >
            ...
            {!vendorId && (
              <input
                ...
                className="w-full rounded-lg border border-[var(--ch-border)] bg-[var(--ch-surface)] px-3 py-2 text-sm text-[var(--ch-text-primary)] placeholder:text-[var(--ch-text-muted)] focus:border-[var(--ch-accent)]/50 focus:outline-none"
              />
            )}
          </div>
          ...
          <div>
            ...
            <input
              ...
              className="w-full rounded-lg border border-[var(--ch-border)] bg-[var(--ch-surface)] px-3 py-2 text-sm text-[var(--ch-text-primary)] focus:border-[var(--ch-accent)]/50 focus:outline-none"
            />
          </div>
          ...
          <div>
            ...
            <textarea
              ...
              rows={3}
              className="w-full resize-none rounded-lg border border-[var(--ch-border)] bg-[var(--ch-surface)] px-3 py-2 text-sm text-[var(--ch-text-primary)] placeholder:text-[var(--ch-text-muted)] focus:border-[var(--ch-accent)]/50 focus:outline-none"
            />
          </div>
        </div>

        <div className="mt-auto flex gap-3 border-t border-[var(--ch-border)] pt-4">
          <button
            type="button"
            onClick={submit}
            disabled={saving}
            className="flex-1 rounded-lg border border-[var(--ch-accent)]/30 bg-[var(--ch-accent)]/20 py-2.5 text-sm font-medium text-[var(--ch-accent)] transition-colors hover:bg-[var(--ch-accent)]/30 disabled:opacity-40"
          >
          ...
          <button
            type="button"
            onClick={onClose}
            className="rounded-lg bg-[var(--ch-surface)] px-4 py-2.5 text-sm text-[var(--ch-text-muted)] transition-colors hover:bg-[var(--ch-page-bg)]"
          >
            Cancel
          </button>
        </div>
