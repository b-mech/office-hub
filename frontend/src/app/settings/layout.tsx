    ...
    <main className="min-h-screen bg-[var(--ch-page-bg)] text-[var(--ch-text-primary)]">
      <div className="flex min-h-screen">
              ...
              return (
                <Link
                  ...
                  className={`rounded-lg px-3 py-2 text-sm font-medium transition ${
                    active
                      ? "border border-[var(--ch-accent)]/35 bg-[var(--ch-accent)]/15 text-[var(--ch-accent)]"
                      : "border border-transparent text-[var(--ch-text-secondary)] hover:bg-[var(--ch-surface)] hover:text-[var(--ch-text-primary)]"
                  }`}
                >
                  {item.label}
                </Link>
        ...
        <section className="min-w-0 flex-1">
          <div className="border-b border-[var(--ch-border)] px-8 py-5 text-sm text-[var(--ch-text-secondary)]">
            <span>Settings</span>
